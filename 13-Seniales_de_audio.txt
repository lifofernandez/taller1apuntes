...
1 En este apunte nos referiremos exclusivamente a las señales de audio analógico, y no serán tratadas las
...
l egar las dos señales invertidas de fase a la entrada del dispositivo (por ejemplo una
...
l amados lazos de tierra (Ground Loops). La única solución apropiada para este tipo de
...
2 Esto se puede observar en la fórmula de resistencia eléctrica (R) de un conductor:
...
Plug y Jack
polaridad se mantendrá correcta.
...
Existe otro tipo de conexión l amada inserción
...
P ara el presente apunte fueron seleccionados y traducidos fragmentos del libro :
