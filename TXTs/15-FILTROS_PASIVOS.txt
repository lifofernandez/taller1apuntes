...
- Filtros pasivos: son los que se componen de combinaciones en serie o paralelo
de los elementos R, L o C.
...
Si la f = 0Hz entonces la reactancia capacitiva estará dada por:
...
La magnitud de la razón Vo/Vi, o sea la ganancia, estará dada por:
